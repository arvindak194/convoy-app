  ...
  return (
    <div className="min-h-screen bg-brand-dark/80 backdrop-blur-md flex flex-col items-center justify-center p-4 text-zinc-100">
      <motion.div
        ...
        className="max-w-md w-full bg-brand-mid/60 border border-brand-light/20 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-brand-light/20 text-center"
      >
